...
COL_COMMENTS = {
    ...
    "Resumen_Diario": {
        ...
        "interacciones_dia": "Suma total de intentos de llamada realizados en el da con tmo>0.",
        ...
        "conversion_%": "Porcentaje de ventas sobre leads insertados (ventas / contactados * 100).",
    ...
    "Agentes": {
        ...
        "leads_cerrados": "Cantidad leads donde el agente fue el ultimo en gestionar (coincide con lastOcmAgent).",
        ...
        "tiempo_total_llamadas_hms": "TMO Total HMS (Suma TMO).",
        ...
        "sla_operativo_mediana_hms": "Mediana SLA (Horario Operativo) para leads contactados  por el agente en primer llamada.",
        "sla_extra_mediana_hms": "Mediana SLA (Horario Extra) para leads contactados por el agente en primer llamada.",
        "sla_fds_mediana_hms": "Mediana SLA (Fines de Semana) para leads contactados por el agente en primer llamada.",
