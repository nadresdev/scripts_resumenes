...
def generate_executive_summary():
    ...
    try:
        ...
        row_labels = [
            ...
            "conversion sobre interacciones con contacto_%", # interacciones de venta / interacciones tmo > 0 *100
            "conv_contactado_cerrado_%", # leads venta y cerrado / leads contactados *100
